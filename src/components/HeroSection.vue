  ...
  <section id="home" class="min-h-screen relative pt-20" ref="vantaRef">
    <div class="max-w-7xl mx-auto px-6 w-full relative z-10 pb-6">
      ...
      <div class="text-center">
        <h1 class="text-black dark:text-white text-7xl sm:text-8xl lg:text-9xl font-extrabold leading-none">APP DEVELOPER</h1>
        <h1 class="text-7xl sm:text-8xl lg:text-9xl font-extrabold leading-none" style="-webkit-text-stroke: 2px black; -webkit-text-fill-color: transparent">& BRAND DESIGNER</h1>
      </div>

      <div class="flex justify-center mt-6 mb-10 w-full">
        <div class="w-full max-w-4xl flex justify-between items-center px-4">
          <p class="text-lg md:text-xl text-gray-700 dark:text-gray-400">Based in Bali, Singaraja</p>
      ...
      <div class="flex justify-center relative z-50 mt-[-200px]">
